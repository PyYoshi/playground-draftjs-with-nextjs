...
const initialEditorState: RawDraftContentState = {
  ...
  entityMap: {
    ...
    "1": {
      ...
      mutability: "IMMUTABLE",
      data: {
        src: "https://www.youtube.com/watch?v=lT67liGjZhw"
      }
    }
  }
};
...
//     {
//       "key": "7imp2",
//       "text": "　「吾輩は猫である」は雜誌ホトヽギスに連載した續き物である。固より纒つた話の筋を讀ませる普通の小説ではないから、どこで切つて一册としても興味の上に於て左したる影響のあらう筈がない。然し自分の考ではもう少し書いた上でと思つて居たが、書肆が頻りに催促をするのと、多忙で意の如く稿を續ぐ餘暇がないので［＃「ないので」は底本では「なので」］、差し當り是丈を出版する事にした。",
//       "type": "unstyled",
//       "depth": 0,
//       "inlineStyleRanges": [],
//       "entityRanges": [],
...
//     {
//       "key": "r9q6",
//       "text": "　自分が既に雜誌へ出したものを再び單行本の體裁として公にする以上は、之を公にする丈の價値があると云ふ意味に解釋されるかも知れぬ。「吾輩は猫である」が果してそれ丈の價値があるかないかは著者の分として言ふべき限りでないと思ふ。たゞ自分の書いたものが自分の思ふ樣な體裁で世の中へ出るのは、内容の價値如何に關らず、自分丈は嬉しい感じがする。自分に對しては此事實が出版を促がすに充分な動機である。",
//       "type": "unstyled",
//       "depth": 0,
//       "inlineStyleRanges": [],
//       "entityRanges": [],
...
//     {
//       "key": "5dhim",
//       "text": "　此書を公けにするに就て中村不折氏は數葉の挿畫をかいてくれた。橋口五葉氏は表紙其他の模樣を意匠してくれた。兩君の御蔭に因つて文章以外に一種の趣味を添へ得たるは余の深く徳とする所である。［＃「。」は底本では「、」］",
//       "type": "unstyled",
//       "depth": 0,
//       "inlineStyleRanges": [],
//       "entityRanges": [],
...
//     {
//       "key": "amlbl",
//       "text": "　自分が今迄「吾輩は猫である」を草しつゝあつた際、一面識もない人が時々書信又は繪端書抔をわざ／＼寄せて意外の褒辭を賜はつた事がある。自分が書いたものが斯んな見ず知らずの人から同情を受けて居ると云ふ事を發見するのは非常に難有い。今出版の機を利用して是等の諸君に向つて一言感謝の意を表する。",
//       "type": "unstyled",
//       "depth": 0,
//       "inlineStyleRanges": [],
//       "entityRanges": [],
...
//     {
//       "key": "ee523",
//       "text": "　此書は趣向もなく、搆造もなく、尾頭の心元なき海鼠の樣な文章であるから、たとひ此一卷で消えてなくなつた所で一向差し支へはない。又實際消えてなくなるかも知れん。然し將來忙中に閑を偸んで硯の塵を吹く機會があれは再び稿を續ぐ積である。猫が生きて居る間は――猫が丈夫で居る間は――猫が氣が向くときは――余も亦筆を執らねばならぬ。",
//       "type": "unstyled",
//       "depth": 0,
//       "inlineStyleRanges": [],
//       "entityRanges": [],
...
//       "mutability": "IMMUTABLE",
//       "data": {
//         "src": "https://upload.wikimedia.org/wikipedia/commons/7/74/Ich_der_Kater.jpg",
//         "width": 98,
//         "alignment": "center"
//       }
//     },
